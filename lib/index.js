...
var RichMarkdownEditor = (_temp = _class = function (_React$PureComponent) {
  ...
  function RichMarkdownEditor(props) {
    ...
    _this.value = function () {
      return _this.serializer.serialize(_this.state.editorValue);
    };
    ...
    _this.render = function () {
      var _this$props = _this.props,
          ...
          onClickHeader = _this$props.onClickHeader,
          ...
          rest = _objectWithoutProperties(_this$props, ["readOnly", "pretitle", "placeholder", "onSave", "onChange", "onCancel", "uploadImage", "onSearchLink", "onClickLink", "onImageUploadStart", "onImageUploadStop", "onShowToast", "onClickHeader", "className", "style", "dark", "defaultValue", "autoFocus", "plugins"]);
    ...
    _this.serializer = props.serializer || _serializer2.default;
